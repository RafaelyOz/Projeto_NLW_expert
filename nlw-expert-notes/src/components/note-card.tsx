...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                <Dialog.Overlay className="insert-8 fixed bg-black/60" />
                <Dialog.Content className="fixed overflow-hidden insert-0 md:insert-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none">
